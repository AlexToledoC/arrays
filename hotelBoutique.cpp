...
Descripción: simular las reservaciones del hotel boutique */
...
subtotal, dias, total, sencilla[5],
...
int main()
{
	...
	cout << "Escoja el tipo de habitación ingresando el respecitvo número (1-3):\n";
	cin >> seleccion;
	switch(seleccion)
	{
		case 1:
